...
require (
	// Terminal UI for logger (local dev handler)
	charm.land/lipgloss/v2 v2.0.3

	// GCP clients (for pkg/clients)
...
replace github.com/osv/shared/proto => ../proto
