...
type ReportSubmittedEvent struct {
	...
	Packages   []agententity.Package `json:"unenriched_packages"` // packages without CVEs
	OccurredAt time.Time        `json:"occurred_at"`
}

func (p *AgentPublisher) PublishAgentRegistered(ctx context.Context, agent *agententity.Agent) error {
...
func (p *AgentPublisher) PublishReportSubmitted(ctx context.Context, agentID, reportID uuid.UUID, unenrichedPkgs []agententity.Package) error {
