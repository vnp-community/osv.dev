...
func (p *RustParser) Parse(ctx context.Context, filePath string) ([]parserentity.ProductInfo, error) {
...
//	name = "openssl"
//	version = "0.10.55"
func parseCargoLock(_ context.Context, filePath string) ([]parserentity.ProductInfo, error) {
...
func parseCargoToml(_ context.Context, filePath string) ([]parserentity.ProductInfo, error) {
	f, err := os.Open(filePath)
	if err != nil {
		return nil, fmt.Errorf("rust parser: %w", err)
	}
