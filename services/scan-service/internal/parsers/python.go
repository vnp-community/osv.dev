...
func (p *PythonParser) Parse(ctx context.Context, filePath string) ([]parserentity.ProductInfo, error) {
...
func parsePythonRequirement(line string) (parserentity.ProductInfo, bool) {
