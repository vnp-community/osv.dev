...
type ComputeSLAUseCase struct {
	slaConfigRepo sla.SLAConfigRepository
	findingClient findingv1.FindingServiceClient
	eventPub      *natsutil.Publisher
}

func NewComputeSLA(repo sla.SLAConfigRepository, fc findingv1.FindingServiceClient, pub *natsutil.Publisher) *ComputeSLAUseCase {
