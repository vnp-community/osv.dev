...
func (p *NodeJSParser) Parse(ctx context.Context, filePath string) ([]entity.ProductInfo, error) {
...
func parsePackageLock(_ context.Context, filePath string) ([]entity.ProductInfo, error) {
...
func parsePackageJSON(_ context.Context, filePath string) ([]entity.ProductInfo, error) {
	data, err := os.ReadFile(filePath)
	if err != nil {
		return nil, fmt.Errorf("nodejs parser: %w", err)
	}
