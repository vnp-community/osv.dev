...
import (
	...
	authv1 "github.com/defectdojo/identity/internal/infra/auth/genproto/auth/v1"

	// Adapters
	grpcHandler "github.com/defectdojo/identity/adapter/handler/grpc"
	httpHandler "github.com/defectdojo/identity/adapter/handler/http"
	pgRepo "github.com/defectdojo/identity/adapter/repository/postgres"

	// Infrastructure
	"github.com/defectdojo/identity/internal/infrastructure/cache"
	"github.com/defectdojo/identity/internal/infrastructure/jwt"
	"github.com/defectdojo/identity/internal/infrastructure/oauth"

	// Use cases
	ucapikey "github.com/defectdojo/identity/internal/usecase/manage_api_key"
