...
// This file provides OSV ecosystem ↔ PURL conversion infrastructure.
// It is ported from go/purl/purl.go.
...
// Convert parses a PURL string and returns the ecosystem, package, and version.
func Convert(purlStr string) (ecosystem, packageName, version string, err error) {
