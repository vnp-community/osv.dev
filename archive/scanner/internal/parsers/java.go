...
func (p *JavaParser) Parse(ctx context.Context, filePath string) ([]entity.ProductInfo, error) {
...
func parsePOM(_ context.Context, filePath string) ([]entity.ProductInfo, error) {
...
func parseGradle(_ context.Context, filePath string) ([]entity.ProductInfo, error) {
	data, err := os.ReadFile(filePath)
	if err != nil {
		return nil, fmt.Errorf("java parser: %w", err)
	}
...
func (p *RubyParser) Parse(ctx context.Context, filePath string) ([]entity.ProductInfo, error) {
	data, err := os.ReadFile(filePath)
	if err != nil {
...
func (p *ConanParser) Parse(ctx context.Context, filePath string) ([]entity.ProductInfo, error) {
	data, err := os.ReadFile(filePath)
	if err != nil {
