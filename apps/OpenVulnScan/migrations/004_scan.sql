-- 004_scan.sql
-- scan-service schema: scans, findings (scan_findings), web_alerts, discovery_hosts
-- Source: services/scan-service/migrations/001_initial_schema.sql
...
-- NOTE: scan-service findings được đặt tên "scan_findings" để tránh conflict với finding-service
...
CREATE INDEX IF NOT EXISTS idx_scan_findings  ON scan.scan_findings(scan_id);
